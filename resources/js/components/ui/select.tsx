...
function SelectValue({
  ...
  return <SelectPrimitive.Value data-test="123" data-slot="select-value" {...props} />
}
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        "flex w-fit items-center justify-between gap-2 rounded-md border px-3 py-2 text-sm " +
